...
const routes: Routes = [
  ...
  { path: 'EspaceUser', component: PageAdminComponent , canActivate: [AuthGuard]},
  { path: 'EspaceAdmin', component: PageAdminComponent , canActivate: [AuthGuard]},
  ...
  { path: 'user-profile/:id', component: TableauComponent, canActivate: [AuthGuard] }
];
